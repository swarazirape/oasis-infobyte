...
public class Exam_SystemTask4 {
	...
	public void exam_que() {
		...
		while (System.currentTimeMillis() < endtime) {
			...
			System.out.println("\n(1) Cristiano Ronaldo" + "\t" + "(2) Cristiano Robert" + "\t" + "(3) Robert Paul"
					+ "\t" + "(4) Mark Admin");
			...
			System.out.println("1) Prime Minister" + "\t" + "2) Chief Justice of the Supreme Court" + "\t"
					+ "3) President" + "\t" + "4)Speaker of the Lok Sabha");
			System.out.println("Enter correct option");
			ans = sc.nextInt();
			System.out.println("Answer Locked...");
			if (ans == 4) {
	...
	public static void main(String[] args) {
		Exam_SystemTask4 log = new Exam_SystemTask4();
		log.login();
	}
}